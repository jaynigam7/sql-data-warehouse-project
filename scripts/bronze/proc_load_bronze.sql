...
FROM 'C:\Users\HP\Downloads\sql-data-warehouse-project\sql-data-warehouse-project\datasets\source_crm\cust_info_1.csv'
WITH(
      FIRSTROW = 2,
      FIELDTERMINATOR = ',',
      TABLOCK
...
BULK INSERT bronze.cerp_cust_az12
...
SELECT * FROM bronze.cerp_cust_az12;
